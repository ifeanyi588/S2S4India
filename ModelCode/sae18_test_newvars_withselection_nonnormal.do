...
cap log using sae18_log_test_newvars_withselection_nonnormal, text replace
...
local dataout "$analysis\SAE_MATA_wd18_newvars_withselection_nonnormal"
local dataoutu "$analysis\SAE_MATAu_wd18_newvars_withselection_nonnormal"
local dataoutr "$analysis\SAE_MATAr_wd18_newvars_withselection_nonnormal"


local ydump "$analysis\mata_wd18_newvars_withselection_nonnormal"
local ydumpu "$analysis\matau_wd18_newvars_withselection_nonnormal"
local ydumpr "$analysis\matar_wd18_newvars_withselection_nonnormal"
...
**** Predicted poverty
	...
	* Importing dataset (National)
	use "$analysis\final_datau_wd18_newvars_withselection_nonnormal.dta", clear
	gen urban=1
	append using "$analysis\final_datar_wd18_newvars_withselection_nonnormal.dta"
	replace urban=0 if urban==.
	save "$analysis\final_dataur_wd18_newvars_withselection_nonnormal.dta", replace
	...
	* Importing dataset into MI format
	...
	save "$analysis\mi_data_wd18_newvars_withselection_nonnormal", replace 
...
global max_welfareu=r(max) 
	...
	use "$analysis\mi_data_wd18_newvars_withselection_nonnormal", clear
