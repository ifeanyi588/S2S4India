...
local datain "$data2\sae14.dta"
local datainu "$data2\sae14u.dta"
local datainr "$data2\sae14r.dta"
...
************************************************* Second Stage - Urban **********************************************
sae data import, varlist( `xvar111t' qhweight qhclust psu qhnum state district_code) uniqid(id_sae) area(district_code) ///
...
************************************************* Second Stage - Rural **********************************************
sae data import, varlist( `xvar011t' qhweight qhclust psu qhnum state district_code) uniqid(id_sae) area(district_code) ///
