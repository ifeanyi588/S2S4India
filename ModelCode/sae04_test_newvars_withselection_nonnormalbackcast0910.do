...
cap log using sae04_log_test_newvars_withselection_nonnormal0910, text replace
...
local dataout "$analysis\SAE_MATA_wd04_newvars_withselection_nonnormal0910"
local dataoutu "$analysis\SAE_MATAu_wd04_newvars_withselection_nonnormal0910"
local dataoutr "$analysis\SAE_MATAr_wd04_newvars_withselection_nonnormal0910"


local ydump "$analysis\mata_wd04_newvars_withselection_nonnormal0910"
local ydumpu "$analysis\matau_wd04_newvars_withselection_nonnormal0910"
local ydumpr "$analysis\matar_wd04_newvars_withselection_nonnormal0910"
...
estimates save "$estimates/stage1_04_indu_newvars_withselection_nonnormal0910", replace 
...
estimates save "$estimates/stage1_04_indr_newvars_withselection_nonnormal0910", replace 
...
* Export data
sae data export, matasource(`ydumpu') numfiles(1) datasave($analysis\final_datau_wd04_newvars_withselection_nonnormal0910)

* Poverty numbers
sae proc indicator, matasource(`ydumpu') aggids(7 8) indicators(fgt0) plines(57.791668) 

save "$res\impu_wd04_newvars_withselection_nonnormal0910.dta", replace
...
* Export data
sae data export, matasource(`ydumpr') numfiles(1) datasave($analysis\final_datar_wd04_newvars_withselection_nonnormal0910)

* Poverty numbers
sae proc indicator, matasource(`ydumpr') aggids(7 8) indicators(fgt0) plines(57.791668) 

save "$res\impr_wd04_newvars_withselection_nonnormal0910.dta", replace

*************************************************************************************************************************
**** Predicted poverty

	* Importing dataset (National)
	use "$analysis\final_datau_wd04_newvars_withselection_nonnormal0910.dta", clear
	gen urban=1
	append using "$analysis\final_datar_wd04_newvars_withselection_nonnormal0910.dta"
	replace urban=0 if urban==.
	save "$analysis\final_dataur_wd04_newvars_withselection_nonnormal0910.dta", replace
	...
	* Importing dataset into MI format
	...
	save "$analysis\mi_data_wd04_newvars_withselection_nonnormal0910", replace 
...
global max_welfareu=r(max) 
	...
	use "$analysis\mi_data_wd04_newvars_withselection_nonnormal0910", clear
...
*/ 
	...
	*/ 
	...
	estimates save "D:\Poverty_Estimates_India\estimates\replication\sae04_newvars_withselection_nonnormal0910", replace 
	...
	*keep if Nyearsdistrict==4 
	mi estimate: svy: mean Dpoor* povgap* povseverity*, over(urban)
	estimates save "D:\Poverty_Estimates_India\estimates\sae04_completedistrictsubsample_newvars_withselection_nonnormal0910", replace 
	restore 
