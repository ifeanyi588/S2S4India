...
cap log using sae18_log_test_newvars_withselection_nonnormalh3, text replace
...
local dataout "$analysis\SAE_MATA_wd18_newvars_withselection_nonnormalh3"
local dataoutu "$analysis\SAE_MATAu_wd18_newvars_withselection_nonnormalh3"
local dataoutr "$analysis\SAE_MATAr_wd18_newvars_withselection_nonnormalh3"


local ydump "$analysis\mata_wd18_newvars_withselection_nonnormalh3"
local ydumpu "$analysis\matau_wd18_newvars_withselection_nonnormalh3"
local ydumpr "$analysis\matar_wd18_newvars_withselection_nonnormalh3"
...
estimates save "$estimates/stage1_18_indu_newvars_withselection_nonnormalh3", replace 
...
estimates save "$estimates/stage1_18_indr_newvars_withselection_nonnormalh3", replace 
...
* Export data
sae data export, matasource(`ydumpu') numfiles(1) datasave($analysis\final_datau_wd18_newvars_withselection_nonnormalh3)

* Poverty numbers
sae proc indicator, matasource(`ydumpu') aggids(7 8) indicators(fgt0) plines(57.791668) 

save "$res\impu_wd18_newvars_withselection_nonnormalh3.dta", replace
...
* Export data
sae data export, matasource(`ydumpr') numfiles(1) datasave($analysis\final_datar_wd18_newvars_withselection_nonnormalh3)

* Poverty numbers
sae proc indicator, matasource(`ydumpr') aggids(7 8) indicators(fgt0) plines(57.791668) 

save "$res\impr_wd18_newvars_withselection_nonnormalh3.dta", replace

*************************************************************************************************************************
**** Predicted poverty

	* Importing dataset (National)
	use "$analysis\final_datau_wd18_newvars_withselection_nonnormalh3.dta", clear
	gen urban=1
	append using "$analysis\final_datar_wd18_newvars_withselection_nonnormalh3.dta"
	replace urban=0 if urban==.
	save "$analysis\final_dataur_wd18_newvars_withselection_nonnormalh3.dta", replace
	...
	* Importing dataset into MI format
	...
	save "$analysis\mi_data_wd18_newvars_withselection_nonnormalh3", replace 
...
global max_welfareu=r(max) 
	...
	use "$analysis\mi_data_wd18_newvars_withselection_nonnormalh3", clear
...
*/ 
	...
	*/ 
	...
	estimates save "D:\Poverty_Estimates_India\estimates\replication\sae18_newvars_withselection_nonnormalh3", replace 
